...
def train():
    mnist = input_data.read_data_sets("../../../data/data_mnist", one_hot=True)
    ...
    with tf.Session() as sess:
        ...
        for i in range(10000):  # 训练阶段，迭代1000次
            ...
            if i % 100 == 0:  # 每训练100次，测试一次
                accuracy2 = accuracy.eval(feed_dict={x: mnist.test.images, y_actual: mnist.test.labels})
                print("train:" + str(i) + "\taccuracy:" + str(accuracy2))
